...
Extend ArchonMemory with custom local or remote inference engines (e.g. Ollama, CoreML, Cohere).

## Overview

ArchonMemory relies on clean protocols to inject embedding models and structured extraction LLMs.
