...
/// Utility to generate randomized, realistic modern browser headers for requests.
public struct StealthHeaders: Sendable {
    ...
    /// Generates realistic headers for HTTP requests, incorporating a randomized User-Agent.
    public static func standardHeaders() -> [String: String] {
        return [
