...
| `ArchonAgent` | Graphs, routing, tools, handoffs, guardrails, interrupts, checkpoints, evaluation, chat, realtime voice + vision sessions | 🏆 Archon on-device — durability, handoffs, guardrails, eval, full-duplex realtime sessions proven; LangGraph still leads hosted/Python ecosystem maturity | BUILD | [langgraph](https://github.com/langchain-ai/langgraph), [crewAI](https://github.com/crewAIInc/crewAI), [openai-agents-python](https://github.com/openai/openai-agents-python), [AgentRunKit](https://github.com/Tom-Ryder/AgentRunKit), [Conduit](https://github.com/christopherkarani/Conduit); realtime patterns from [livekit](https://github.com/livekit/livekit)/[client-sdk-swift](https://github.com/livekit/client-sdk-swift), [pipecat](https://github.com/pipecat-ai/pipecat), [TEN](https://github.com/TEN-framework/TEN-Agent); on-device STT candidate [WhisperKit](https://github.com/argmaxinc/WhisperKit) |
