...
| Memory and research archive | Local GRDB/SQLite and rebuildable local indexes | Optional CloudKit sync or consumer-owned web research importer | Durable local source of truth; web fetching and credentials stay host-owned |
...
- Competitive-research imports are local after ingestion; the package never
  fetches competitor sites or stores provider credentials.
