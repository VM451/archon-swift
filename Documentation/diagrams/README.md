...
One file per Archon product. Each diagram shows how that product works —
its entry points, internal flow, and boundaries with other products.

| Product | Diagram |
| --- | --- |
| `ArchonCore` | [archon-core.md](archon-core.md) |
...
| `ArchonConnect` | [archon-connect.md](archon-connect.md) |
| `ArchonComputerUse` | [archon-computer-use.md](archon-computer-use.md) |
| `ArchonModelsUI` | [archon-models-ui.md](archon-models-ui.md) |
