...
| [`ArchonAgent`](products/agent.md) | Graph execution, routing, tools, handoffs, guardrails, interrupts, checkpoints, tracing, evaluation, provider adapters | 🏆 Archon on-device — durability, handoffs, guardrails, eval proven; LangGraph still leads hosted/Python ecosystem maturity | Does not own model downloads |
