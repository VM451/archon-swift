...
- [Supported models](reference/supported-models.md) — official-publisher
  MLX-only user-facing browsing, model-family coverage, catalog wiring, and
  the Gemma compatibility convenience.
