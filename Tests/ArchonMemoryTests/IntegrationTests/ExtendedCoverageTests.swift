...
struct ExtendedCoverageTests {
    ...
    func testEntityCKRecordRoundtrip() {
        let zoneID = CKRecordZone.ID(zoneName: "ArchonMemoryZone", ownerName: CKCurrentUserDefaultName)
        let entity = Entity(
            name: "Steve Jobs",
            type: "Person",
            userId: "user-123",
        ...
        #expect(record.recordType == "ArchonEntity")
    ...
    func testRelationCKRecordRoundtrip() {
        ...
        #expect(record.recordType == "ArchonRelation")
