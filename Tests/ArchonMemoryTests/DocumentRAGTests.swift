...
struct DocumentRAGTests {
    ...
    func markdownLoaderParsing() async throws {
        ...
        ArchonMemory is a bi-temporal knowledge graph and local vector store.
    ...
    @Test("KnowledgeBaseIndex and ArchonClient ingest local documents and query with hybrid search")
